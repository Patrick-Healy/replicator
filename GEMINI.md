...
# Save report to file
python scripts/check_compliance.py /path/to/repo --save
```
...
**Repository:** lp_var_inference
**Score:** 9/16 (56%)

## Code-Level Issues
Found **0 errors** and **6 warnings** in source code.

### Warnings
- _estim/ir_estim.m:0 - File uses randomization but no seed is set
```
